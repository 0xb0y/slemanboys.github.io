<html lang="en">
<head>
<title>DEV.slemanboys</title> 
<meta name="description" content="I can't describe myself">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" href="http://www.slemanboys.org/favicon.ico">
	<meta content='http://dev.slemanboys.org/ita/front.png' property='og:image'/>
    <!-- Bootstrap core CSS -->
...
salju -->
  ...
  <div class="main">
    <div class="judul">
      <h1>"Even if I have to carry all the dirty name of this world, it does not matter. If it can make her small world clean again, then I will gladly accept it."</h1>
	  <font face="Courier New" size="3" color="gray">silen76uardian@muslim.com</font>
    </div>

    <div class="footer">
      <h3>sinkaroid@slemanboys:~#</h3>
      <p>Akar yang membusuk di kegelapan~</p>
    </div>
  </div>
...
<!-- this origin code by https://dev.zafkiel.net -->
  </body>
  <audio autoplay>
      <source src=http://dev.slemanboys.org/say.mp3>
</audio>
</html>
